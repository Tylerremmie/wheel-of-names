...
let theWheel = new Winwheel({
    ...
    'segments':        // Define segments including colour and text.
        [
            ...
            { fillStyle: '#c100be', text: 'Jerome', id: Math.floor(Math.random() * Date.now()) },
            ...
            { fillStyle: '#89f26e', text: 'Junaid', id: Math.floor(Math.random() * Date.now()) },
            ...
            { fillStyle: '#bf3529', text: 'Stephanie', id: Math.floor(Math.random() * Date.now()) },
